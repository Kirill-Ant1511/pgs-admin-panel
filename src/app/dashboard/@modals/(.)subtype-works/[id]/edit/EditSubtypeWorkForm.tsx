...
export function EditSubtypeWorkForm({id}: Props) {
    ...
    const {selectedSubtypeWork, getSubtypeWorkById, updateSubtypeWork, getAllSubtypeWorks} = useSubtypeWork()
    const {
        register,
        control,
        handleSubmit,
    ...
    const onSubmit = async (data: Input) => {
        console.log(data)
        await updateSubtypeWork(id, data.code, data.name, data.unitMetering, data.typeWorkId)
    ...
    return <ModalBackground>
        ...
        {selectedSubtypeWork ?
                ...
                <Field>
                        ...
                        <Controller
                            ...
                            >
                                ...
                                <SelectContent>
                                    <SelectGroup defaultValue={selectedSubtypeWork.typeWorkId}>
            ...
            </form> : <p>Такого типа работ не существует</p>
        }
    </ModalBackground>
}
