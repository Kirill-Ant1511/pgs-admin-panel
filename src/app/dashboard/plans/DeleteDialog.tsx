		...
		<Dialog>
			...
			<DialogContent>
				...
				<div className='w-full mt-2 space-y-5'>
                    ...
                    <ul>
                        <li><span className='font-bold'>Участок: </span>{plan.plot.name}</li>
                        <li><span className='font-bold'>Вид работ: </span>{plan.typeWork.name}</li>
                        <li><span className='font-bold'>Тип работ: </span>{plan.subtypeWork.name}</li>
                        <li><span className='font-bold'>Название выработки: </span>{plan.productionName}</li>
                        <li><span className='font-bold'>Объём: </span>{plan.volume}</li>
                    </ul>
					<Button
